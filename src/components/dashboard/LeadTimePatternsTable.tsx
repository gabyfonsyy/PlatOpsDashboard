import type { LeadTimePattern } from "@/lib/lead-cycle-time";
    ...
    <div className="card">
      ...
      <table className="w-full text-sm">
        ...
        <tbody className="divide-y divide-neutral-100">
          {rows.length === 0 ? (
            <tr>
              <td colSpan={4} className="px-4 py-6 text-center text-neutral-400">No recurring high-Lead-Time patterns detected this period.</td>
            </tr>
          ) : (
            rows.map((r) => (
